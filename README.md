...
| `app.js` | Renders the cards, handles EN/IT/中文/한국어 and tag filters, fetches live GitHub stats |
...
{
  "repo": "my-repo",
  "title": { "en": "My Project", "it": "Il mio progetto", "zh": "我的项目", "ko": "내 프로젝트" },
  "description": { "en": "One or two sentences.", "it": "Una o due frasi.", "zh": "一两句话。", "ko": "한두 문장." },
  "tags": ["science"],
...
- Write `title` and `description` in English (`en`), Italian (`it`), Simplified Chinese (`zh`) and Korean (`ko`). If a language is missing, the English text is shown.
